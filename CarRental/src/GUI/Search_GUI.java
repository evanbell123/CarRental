        ...
        rentCarButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (table.getSelectedRow() == -1) {
                    ...
                    /*
                     The accountName, phoneNumber, and address will uniquely identify the customer
                     */
                    String accountName = customerModel.getValueAt(table.getSelectedRow(), 0).toString();
                    String phoneNumber = customerModel.getValueAt(table.getSelectedRow(), 1).toString();
                    String address = customerModel.getValueAt(table.getSelectedRow(), 2).toString();
                    Customer_GUI frame = new Customer_GUI(layout, accountName, phoneNumber, address, Search_GUI.this.controller);
